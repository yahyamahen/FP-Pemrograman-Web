...
// if ($data['no_surat'] != '') {
//    $mpdf->Output("images/" . $data['npm'] . "/surat/" . $data['npm'] . "_" . $data['no_surat'] . ".pdf", \Mpdf\Output\Destination::DOWNLOAD);
// } else {
//    $mpdf->Output("images/" . $data['npm'] . "/surat/" . $npm . "_belum_valid.pdf", \Mpdf\Output\Destination::DOWNLOAD);
// }

if ($data['no_surat'] != null) {
   $mpdf->Output($data['npm'] . "_" . $data['no_surat'] . ".pdf", \Mpdf\Output\Destination::INLINE);
} else {
   $mpdf->Output($data['npm'] . "_belum_valid.pdf", \Mpdf\Output\Destination::INLINE);
}
?>